...
<div class="container mt-5">
    ...
    <form action="{{ route('extra.update', $extra->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama" name="nama" value="{{ $extra->nama }}">
        </div>
        <div class="form-group">
            <label for="keterangan">Keterangan:</label>
            <textarea class="form-control" id="keterangan" name="keterangan">{{ $extra->keterangan }}</textarea>
        </div>
        <div class="form-group">
            <label for="hari">Hari:</label>
            <input type="text" class="form-control" id="hari" name="hari" value="{{ $extra->hari }}">
        </div>
