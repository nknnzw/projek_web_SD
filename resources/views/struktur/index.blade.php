...
<body>
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Data Stuktur</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="section">
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Data Struktur</h1>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                @foreach ($strukturs as $struktur)
                    <tr>
                        <td><img src="{{ asset('images/' . $struktur->foto) }}" width="100"></td>
                        <td>{{ $struktur->nama }}</td>
                        <td>{{ $struktur->jabatan }}</td>
                        <td>
                            <a href="{{ route('struktur.edit', $struktur->id) }}" class="btn btn-warning btn-sm">Edit</a>
                            <a href="{{ route('struktur.show', $struktur->id) }}" class="btn btn-info btn-sm">Show</a>
