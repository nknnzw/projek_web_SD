                    ...
                    <tr>
                        ...
                        <div class="d-flex gap-1">
                          ...
                          <form action="{{ route('prestasi.destroy', $prestasi->id) }}" method="POST">
                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalHapusPrestasi{{ $prestasi->id }}">Hapus</button>
                          <div class="modal fade" id="modalHapusPrestasi{{ $prestasi->id }}" tabindex="-1" aria-labelledby="modalLabelPrestasi{{ $prestasi->id }}" aria-hidden="true">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header bg-danger text-white">
                                    <h5 class="modal-title" id="modalLabelPrestasi{{ $prestasi->id }}">Konfirmasi Hapus</h5>
